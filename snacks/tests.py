...
class SnackTests(TestCase):
    def setUp(self):
        ...
        self.snack = Snack.objects.create(name="pickle", purchaser=self.user, description="test")
    ...
    def test_snack_content(self):
        ...
        self.assertEqual(f"{self.snack.purchaser.username}", "tester")
    ...
    def test_snack_update_view_redirect(self):
        response = self.client.post(
            ...
            {"name": "Updated name", "description": "updated", "purchaser": self.user.id},
        )
